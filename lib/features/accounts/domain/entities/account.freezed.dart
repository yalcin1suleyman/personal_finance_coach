...
class _$AccountImpl extends _Account {
  ...
  @override
  String toString() {
    return 'Account(id: $id, name: $name, type: $type, icon: $icon, balance: $balance, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, type, icon, balance, createdAt);
...
abstract class _Account extends Account {
  const factory _Account(
      ...
      @HiveField(2) required final AccountType type,
      @HiveField(3) required final String icon,
      @HiveField(4) required final double balance,
      @HiveField(5) required final DateTime createdAt}) = _$AccountImpl;
