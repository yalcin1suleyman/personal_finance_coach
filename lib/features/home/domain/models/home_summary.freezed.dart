...
mixin _$HomeSummary {
  ...
  double get totalEffortHours => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      totalEffortHours: null == totalEffortHours
          ? _value.totalEffortHours
          : totalEffortHours // ignore: cast_nullable_to_non_nullable
              as double,
...
class _$HomeSummaryImpl implements _HomeSummary {
  ...
  final List<FinanceTransaction> _recentTransactions;
  @override
  List<FinanceTransaction> get recentTransactions {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.totalEffortHours, totalEffortHours) ||
                other.totalEffortHours == totalEffortHours) &&
